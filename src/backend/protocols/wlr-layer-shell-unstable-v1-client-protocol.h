 ...
 * The compositor will respond with a layer_surface.configure event.
 ...
 * types of keyboard interaction possible
 *
 ...
 *
 * A positive zone is the distance from the edge that is considered
 * exclusive.
 *
