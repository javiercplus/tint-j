 ...
 * letting them request certain actions on them, like minimizing, etc.
 *
...
struct zwlr_foreign_toplevel_manager_v1_listener {
	 ...
	 *
	 * All initial details of the toplevel (title, app_id, states,
	 * etc.) will be sent immediately after this event via the
	 * corresponding events in zwlr_foreign_toplevel_handle_v1.
	 */
 ...
 * @ingroup iface_zwlr_foreign_toplevel_manager_v1
 *
 * Indicates that the client no longer wishes to receive events for new
 ...
 *
 * The different states that a toplevel can have. These have the same
 * meaning as the states with the same names defined in
 * xdg-toplevel.
 */
...
struct zwlr_foreign_toplevel_handle_v1_listener {
	 ...
	 * output_enter event with the same output has been emitted before
	 * this event.
	 */
	 ...
	 *
	 * This event is emitted immediately after the toplevel is
	 * created and each time the toplevel state changes.
	 *
	 * The array contains the XOR of the current and previous state,
	 * with one state per uint32. The state flags are described in the
	 * state enum.
	 */
	 ...
	 * guaranteed there won't be any more events for this toplevel. The
	 * toplevel becomes inert so any requests will be ignored except
	 * the destroy request.
	 */
	void (*closed)(void *data,
		       struct zwlr_foreign_toplevel_handle_v1 *zwlr_foreign_toplevel_handle_v1);
	/**
	 * parent toplevel change
	 *
	 * This event is emitted whenever the parent of the toplevel
	 * changes. No parent means the new parent is NULL.
	 */
 ...
 * @ingroup iface_zwlr_foreign_toplevel_handle_v1
 */
#define ZWLR_FOREIGN_TOPLEVEL_HANDLE_V1_PARENT_SINCE_VERSION 1
 ...
 * @ingroup iface_zwlr_foreign_toplevel_handle_v1
 *
 * Request activation of this toplevel. The compositor may ignore this
 * request.
 */
static inline void
 ...
 * typically send an xdg_toplevel::close event to the toplevel's surface.
 */
static inline void
 ...
 * @ingroup iface_zwlr_foreign_toplevel_handle_v1
 *
 * The rectangle of the surface specified by this request corresponds to
 * the place where the app using this protocol represents the given toplevel.
 * It can be used by the compositor as a hint for any operation like
 * minimizing. The rectangle is in surface-local coordinates.
 */
static inline void
 ...
 * @ingroup iface_zwlr_foreign_toplevel_handle_v1
 *
 * Destroys the toplevel handle. The toplevel will still exist but this
 * handle will not receive any more events.
 */
static inline void
